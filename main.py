...
class MenuInicio:
    ...
    def procesar_opcion(self, opcion: str) -> bool:
        ...
        if opcion == "1":
            ...
            # Obtenemos la lista completa de canciones que ya tiene tu catálogo
            todas = []
            ...
            if todas:
                # Las ordenamos por popularidad de mayor a menor y cortamos a 10
                top_10 = sorted(
                    todas, 
        ...
        # 2. BUSCAR CANCIÓN
            ...
            if criterio:
                ...
                # Intentamos usar el método del catálogo o la lista directa
                resultados = []
      ...
      # 3. FILTRAR CANCIONES
            ...
            if valor:
                ...
                # Obtenemos la lista de canciones directamente del catálogo
                todas = []
                if hasattr(self.catalogo, "listar"):
                    todas = self.catalogo.listar()
                elif hasattr(self.catalogo, "canciones"):
                ...
                for c in todas:
                    # Extraemos TODOS los valores de las propiedades del objeto o diccionario
                    valores = []
                    ...
                    # Convertimos todo a un solo texto en minúsculas y sin tildes
                    texto_cancion = []
                    for v in valores:
        ...
        # 4 a 8. OPCIONES AVANZADAS DEL UML (Usa funciones nativas si existen)
